...
nuclei -l /root/recon/$domain/subdomain/good/fainal/best/all_active_sub.txt  -t /root/cent-nuclei-templates/ -c 50 -o /root/recon/$domain/scan/nuclei/my-all.txt -v
