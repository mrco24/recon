...
naabu -list /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt -p- -exclude-ports 80,443,21,22,25 -o /root/recon/$domain/scan/filter-all-open-port.txt
done
}
open_port
...
gowitness file -f /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt
done
}
web_Screenshot
...
for domain in $(cat $host);
do
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | nuclei -t /root/templates/my-nuclei-templates/My-Nuclei-Templates/php-my-admin/phpmyadmin-setup.yaml  -o /root/recon/$domain/scan/nuclei/Php-My-Admin/php_my_admin.txt -v
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | nuclei -t /root/templates/my-nuclei-templates/My-Nuclei-Templates/php-my-admin/phpadmin.yaml  -o /root/recon/$domain/scan/nuclei/Php-My-Admin/php_admin.txt -v
done
}
Php _ My _ Admin
...
for domain in $(cat $host);
do
cf-check -d /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt > /root/recon/$domain/subdomain/good/cloudflare_check.txt
done
}
CloudFlare_Checker
...
for domain in $(cat $host);
do
dirsearch -l /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt  > /root/recon/$domain/dri/dri_activ.txt
done
}
FUZZ_active
...
for domain in $(cat $host);
do
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | nuclei -t /root/templates/my-nuclei-templates/cves/  -o /root/recon/$domain/scan/nuclei/my-cves.txt -v
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | nuclei -t /root/templates/my-nuclei-templates/vulnerabilities/  -o /root/recon/$domain/nuclei/scan/my-vulnerabilities.txt -v
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | nuclei -t /root/templates/my-nuclei-templates/technologies/  -o /root/recon/$domain/scan/nuclei/my-technologies.txt -v
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | nuclei -t /root/templates/my-nuclei-templates/My-Nuclei-Templates/ -o /root/recon/$domain/scan/nuclei/My-Nuclei-Templates.txt -v
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | nuclei -t /root/templates/my-nuclei-templates/Nuclei 1/ -o /root/recon/$domain/scan/nuclei/my-Nuclei.txt -v
...
for domain in $(cat $host);
do
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | waybackurls | tee /root/recon/$domain/url/waybackurls.txt
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | hakrawler | grep $domain > /root/recon/$domain/url/hakrawler-urls.txt
gospider -S /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt -c 10 -d 1 --other-source | grep $domain | grep -o 'https\?://[^ ]\+' > /root/recon/$domain/url/gospider-url.txt
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | gau --threads 15 | tee -a /root/recon/$domain/url/gau-urls.txt
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | katana -o /root/recon/$domain/url/katana.txt
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | xargs -n 1 -I {} python3 /root/OK-VPS/tools/ParamSpider/paramspider.py --domain {} --level high  | grep -o 'https\?://[^ ]\+' > /root/recon/$domain/url/all_spiderparamters.txt
...
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | getJS --complete | grep $domain | tee /root/recon/$domain/js_url/Domain_js_urls.txt
...
gf interestingsubs /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt |  tee /root/recon/$domain/gf/interestingsubs.txt
...
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | /root/OK-VPS/tools/findom-xss/./findom-xss.sh
done
}
Refactors_xss
