...
for domain in $(cat $host);
do
naabu --list /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt -o /root/recon/$domain/scan/open-port.txt
done
}
open_port
...
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | gau --threads 5 > /root/recon/$domain/url/gau-urls.txt
cat /root/recon/$domain/subdomain/good/Gen_sub/active_subdomain.txt | httpx | katana -o /root/recon/$domain/url/katana.txt
